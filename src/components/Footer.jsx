...
function Footer() {
  ...
  return (
    <Section className="main-container-footer">
      <div class="max-width-footer-items">
        <Logo>
          <svg
        ...
        <ListFooter>
          <div className=" box-margin company">
            <p className="footer-ps">COMPANY</p>
            <ul className="footer-lis">
              <li>About</li>
              <li>Jobs</li>
          ...
          <div className=" box-margin communitist">
            <p className="footer-ps">COMMUNITISTIC</p>
            <ul className="footer-lis">
              <li>For Artists</li>
              <li>Developers</li>
              <li>Advertising</li>
          ...
          <div className=" box-margin useful-links">
            <p className="footer-ps">USEFUL LINKS</p>
            <ul className="footer-lis">
              <li>Support</li>
              <li>Web Player</li>
        ...
        <div className="handles-info">
          <div className="handles">
            <Icons>
              ...
              <div className="icon-div">
                <FacebookRoundedIcon className="icon" fontSize="large" />
              </div>
            </Icons>
          </div>
        </div>
      </div>
      <div className="language-year-div">
        ...
        <div className="content-language">
          <div className="content-language-child">
            <PublicIcon className="public"fontSize="smaller"/>
            <span>India(English)</span>
          </div>
          <span>{year} Spotify Ab</span>
        </div>
      </div>
    </Section>
  );
